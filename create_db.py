...
conn.execute('CREATE TABLE IF NOT EXISTS energy_records (id INTEGER PRIMARY KEY AUTOINCREMENT, device_id TEXT NOT NULL, energy_wh REAL NOT NULL, recorded_at TEXT NOT NULL, record_date TEXT NOT NULL, record_hour INTEGER NOT NULL, power_w REAL)')
